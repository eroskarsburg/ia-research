...
> Cada slot contém um valor específico, e juntos eles descrevem um cachorro específico. Esses slots podem também conter outros frames, criando uma hierarquia ou rede de informações interligadas.
...
4. **Propriedades de Dados (Data Properties):** Relacionam indivíduos a valores de dados (números, textos, datas).
5. **Propriedades de Objetos (Object Properties):** Relacionam indivíduos a outros indivíduos.
6. **Axiomas:** Declarações que especificam fatos sobre classes e propriedades, incluindo restrições e regras.
